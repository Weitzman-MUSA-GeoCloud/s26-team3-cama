...
DIR_NAME = pathlib.Path(__file__).parent.parent
    ...
    with open(sql_path, 'r', encoding='utf-8') as sql_file:
        ...
        sql_query = render_template(
            sql_query_template,
            {
                ...
                'dataset_name_source': os.environ['DATA_LAKE_DATASET_SOURCE'],
                'dataset_name_core': os.environ['DATA_LAKE_DATASET_CORE'],
                'dataset_name_derived': os.environ['DATA_LAKE_DATASET_DERIVED']
            }
        )
